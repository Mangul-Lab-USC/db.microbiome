...
# The names of the text files that hold the csv styled lists matching taxID's to filenames.one is a list of directories, so must be treated differently
fungiDB_filename = "/u/home/a/akarlsbe/scratch/db.microbiome/Fungi/code/Fungidb_csv.txt"
# fungiDB_filename = "/Users/aaronkarlsberg/Desktop/199/db.microbiome/Fungi/Code/Fungidb_csv.txt"
...
def make_array_of_file_paths():
	...
	# local
	# filePathList = "/Users/aaronkarlsberg/Desktop/test.list"
...
# modify filename from dictionaries to compare.
	fileName = re.search(r'^(.+)/([^/]+)$', filePath).group(2).strip()

	print(fungiDB_dict[fileName][0])
	print(fungiDB_dict[fileName][1].split(' ', 1)[0].lower())
# print(fungiDB_dict.keys()
...
# filesToParse = ["/Users/aaronkarlsberg/Desktop/FungiDB-41_YlipolyticaCLIB122_Genome.fasta"]
# print(filesToParse)

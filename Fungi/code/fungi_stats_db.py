...
onek_filename = "../fungi/code/updated_onek_csv.txt" # This one is a list of directories, so must be treated differently
ensembl_filename = "../fungi/code/updated_ensemble_csv.txt"
ncbi_filename = "../fungi/code/NCBI_taxID_list.txt"
onek_filename = "../fungi/code/1k_taxid_filenames.txt" # This one is a list of directories, so must be treated differently
fungiDB_filename = "../db.microbiome/Fungi/code/Fungidb_csv.txt"
...
# 	onek_path = "../fungi/1K" # leads to the list of directories
# 	ensembl_path = "../fungi/ENSEMBLE"
#	ncbi_path = "../fungi/NCBI"
...
def make_array_of_file_paths():
	filesToParse = []
	filePathList = "../db.microbiome/fungi/code/filepaths.list"
